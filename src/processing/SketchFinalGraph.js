...
export default () => {
  ...
  const setup = async (p5, canvasParentRef) => {
    ...
    bgColor = p5.color(243, 243, 243);
    dotInitializeColor = p5.color(217,217,217);
    myDotColor = p5.color(0, 10, 255);
    inFilterColor = p5.color(164, 155, 243);
    outOfFilterColor = p5.color(217,217,217);
  ...
  function filterDots(p5) {
    ...
    for (let i = 0; i < allDots.length - 1; i++) {
      ...
      if (cur_index > IN_INDEX){ // out of filter
        cur_index = OUT_INDEX;
